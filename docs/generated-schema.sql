...
('I.
A SCANDAL IN BOHEMIA', '<div id="ch01"><h2><a id="chap01"></a>I.<br>A SCANDAL IN BOHEMIA</h2>
    <h3>I.</h3>
    <p class="pfirst">
...
('II.
THE RED-HEADED LEAGUE', '<div id="ch02"><h2><a id="chap02"></a>II.<br>THE RED-HEADED LEAGUE</h2>
    ...
    <p>
    “Why, indeed? You seem most fortunate in having an <i>employé</i> who
    ...
    <p>
    “‘Is to copy out the <i>Encyclopædia Britannica</i>. There is the
    ...
    c’est rien—l’œuvre c’est tout</i>,’ as Gustave
    Flaubert wrote to George Sand.”
    </p></div>'),
('III.
A CASE OF IDENTITY', '<div id="ch03"><h2><a id="chap03"></a>III.<br>A CASE OF IDENTITY</h2>
    <p class="pfirst">
    <span class="dropcap" style="font-size: 1.50em">“M</span>y dear
    ...
    <p>
    “I advertised for him in last Saturday’s <i>Chronicle</i>,”
...
(' IV.
THE BOSCOMBE VALLEY MYSTERY', '<div id="ch04"><h2><a id="chap04"></a> IV.<br>THE BOSCOMBE VALLEY MYSTERY</h2>
    <p class="pfirst">
    ...
    <p>
    “<i>Nous verrons</i>,” answered Holmes calmly. “You work your
...
('V.
THE FIVE ORANGE PIPS', '<div id="ch05"><h2><a id="chap05"></a>V.<br>THE FIVE ORANGE PIPS</h2>
    <p class="pfirst">
    ...
    <p>
    “I searched the Dundee records, and when I found that the barque <i>Lone
    ...
    <p>
    “The <i>Lone Star</i> had arrived here last week. I went down to the
...
('VI.
THE MAN WITH THE TWISTED LIP', '<div id="ch06"><h2><a id="chap06"></a>VI.<br>THE MAN WITH THE TWISTED LIP</h2>
    <p class="pfirst">
    ...
    all? I was Isa Whitney’s medical adviser, and as such I had influence
    ...
    friend of mine here, Mr. Isa Whitney, and I wish to speak with him.”
    </p>
    <p>
    ...
    sudden pluck at my skirt, and a low voice whispered, “Walk past me, and
    then look back at me.” The words fell quite distinctly upon my ear. I
    ...
    had written my note, paid Whitney’s bill, led him out to the cab, and
    ...
    an hour’s purchase; for I have used it before now for my own purposes,
    and the rascally Lascar who runs it has sworn to have vengeance upon me. There
    is a trap-door at the back of that building, near the corner of Paul’s
    ...
    here. All right, John; we shall not need you. Here’s half a crown. Look
    out for me to-morrow, about eleven. Give her her head. So long, then!”
    </p>
    <p>
    ...
    makes you quite invaluable as a companion. ’Pon my word, it is a great
    ...
    upon. There’s plenty of thread, no doubt, but I can’t get the end
    ...
    by Mrs. St. Clair’s story, he was known to have been at the foot of the
    stair within a very few seconds of her husband’s appearance at the
    ...
    pennies and half-pennies—421 pennies and 270 half-pennies. It was no
    ...
    coat’s sinking. He throws it out, and would have done the same with the
    ...
    at the first glance so simple and yet which presented such difficulties.”
    </p>
    <p>
    ...
    have already, I have little doubt, caught the clink of our horse’s
    feet.”
    </p>
    <p>
    ...
    A stable-boy had run out to the horse’s head, and springing down, I
    ...
    assistance, either to you or to my friend here, I shall be indeed happy.”
    </p>
    <p>
    ...
    boots. “I think, Watson, that you are now standing in the presence of one
    ...
    joking,” he continued, seeing my look of incredulity. “I have just
    ...
    the stone-flagged passage, in a peaked cap and frogged jacket. “I wish to
    ...
    is!” He quietly shot back a panel in the upper part of the door and
    glanced through.
    </p>
    <p>
    ...
    doesn’t look a credit to the Bow Street cells, does he?” He slipped
    ...
    destiny. “Be it so,” said he. “And pray what am I charged
    with?”
    </p>
    <p>
    “With making away with Mr. Neville St.— Oh, come, you can’t
    be charged with that unless they make a case of attempted suicide of it,”
    said the inspector with a grin. “Well, I have been twenty-seven years in
    ...
    “God help me, I would not have them ashamed of their father. My God! What
    ...
    he, “of course you can hardly avoid publicity. On the other hand, if you
    ...
    case would then never go into court at all.”
    </p>
    <p>
...
('VII.
THE ADVENTURE OF THE BLUE CARBUNCLE', '<div id="ch07"><h2><a id="chap07"></a>VII.<br>THE ADVENTURE OF THE BLUE CARBUNCLE</h2>
    <p class="pfirst">
    ...
    <p>
    “It’s more than a precious stone. It is <i>the</i> precious
    stone.”
    </p>
    <p>
    ...
    <p>
    “Oh, in the <i>Globe</i>, <i>Star</i>, <i>Pall Mall</i>, <i>St.
    James’s Gazette</i>, <i>Evening News</i>, <i>Standard</i>, <i>Echo</i>,
    ...
    <p>
    “Ah! yes, I see. But you see, sir, them’s not <i>our</i>
    geese.”
    </p>
    <p>
    “Indeed! Whose, then?”
    ...
    <p>
    “‘December 22nd. Twenty-four geese at 7<i>s</i>.
    6<i>d</i>.’”
    </p>
    <p>
...
('VIII.
THE ADVENTURE OF THE SPECKLED BAND', '<div id="ch08"><h2><a id="chap08"></a>VIII.<br>THE ADVENTURE OF THE SPECKLED BAND</h2>
    <p class="pfirst">
...
('IX.
THE ADVENTURE OF THE ENGINEER’S THUMB', '<div id="ch09"><h2><a id="chap09"></a>IX.<br>THE ADVENTURE OF THE ENGINEER’S THUMB</h2>
    <p class="pfirst">
    ...
    fair sum of money through my poor father’s death, I determined to start
    ...
    Stark’ engraved upon it. Close at his heels came the colonel himself, a
    ...
    accent. ‘You have been recommended to me, Mr. Hatherley, as being a man
    ...
    <p>
    “‘If I promise to keep a secret,’ said I, ‘you
    may absolutely depend upon my doing so.’
    </p>
    <p>
    ...
    ‘I know that clerks are sometimes curious as to their master’s
    affairs. Now we can talk in safety.’ He drew up his chair very close to
    ...
    I; ‘my time is of value.’ Heaven forgive me for that last sentence,
    ...
    fuller’s-earth is a valuable product, and that it is only found in one or
    ...
    small place—within ten miles of Reading. I was fortunate enough to
    discover that there was a deposit of fuller’s-earth in one of my fields.
    ...
    my confidence now, Mr. Hatherley, and I have shown you how I trust you.’
    He rose as he spoke. ‘I shall expect you, then, at Eyford at
    11:15.’
    </p>
    <p>
    ...
    station after eleven o’clock. I was the only passenger who got out there,
    ...
    a few minutes,’ said he, throwing open another door. It was a quiet,
    ...
    me, to speak calmly; ‘I would go. I should not stay here. There is no
    good for you to do.’
    </p>
    <p>
    “‘But, madam,’ said I, ‘I have not yet done what
    I came for. I cannot possibly leave until I have seen the machine.’
    </p>
    <p>
    “‘It is not worth your while to wait,’ she went on.
    ‘You can pass through the door; no one hinders.’ And then, seeing
    that I smiled and shook my head, she suddenly threw aside her constraint and
    made a step forward, with her hands wrung together. ‘For the love of
    Heaven!’ she whispered, ‘get away from here before it is too
    late!’
    </p>
    <p>
    ...
    ‘By the way, I was under the impression that I left this door shut just
    ...
    the machine.’ He took a step backward, slammed the little door, and
    ...
    away from her. ‘You will be the ruin of us. He has seen too much. Let me
    pass, I say!’ He dashed her to one side, and, rushing to the window, cut
    ...
    the particulars of my night’s adventure, and I sprang to my feet with the
    ...
    not been heard of since. Was dressed in,’ etc., etc. Ha! That represents
    ...
    fear that they are a good hundred miles off by now.”
    </p>
    <p>
    ...
    Holmes’ ingenuity failed ever to discover the least clue as to their
    whereabouts.
    </p>
    <p>
...
('X.
THE ADVENTURE OF THE NOBLE BACHELOR', '<div id="ch10"><h2><a id="chap10"></a>X.<br>THE ADVENTURE OF THE NOBLE BACHELOR</h2>
    <p class="pfirst">
    ...
    of the <i>Morning Post</i>, and dates, as you see, some weeks back: ‘A
    ...
    <p>
    “Oh, yes; plenty. Then there is another note in the <i>Morning Post</i>
    ...
    <p>
    “And this, of course, remains to you, since the marriage is a <i>fait
    accompli</i>?”
    </p>
    <p>
    ...
    been on a friendly footing for some years—I may say on a <i>very</i>
    ...
    Lestrade. “‘Oct. 4th, rooms 8<i>s</i>., breakfast 2<i>s</i>.
    6<i>d</i>., cocktail 1<i>s</i>., lunch 2<i>s</i>. 6<i>d</i>., glass sherry,
    8<i>d</i>.’ I see nothing in that.”
    </p>
    <p>
...
('XI.
THE ADVENTURE OF THE BERYL CORONET', '<div id="ch11"><h2><a id="chap11"></a>XI.<br>THE ADVENTURE OF THE BERYL CORONET</h2>
    <p class="pfirst">
    ...
    your case, every businesslike precaution should be taken.’
    </p>
    <p>
    ...
    youngster I have opened it myself with the key of the box-room cupboard.’
    </p>
    <p>
    ...
    continue my investigations outside.”
    </p>
    <p>
    ...
    his tool and was in the habit of seeing him nearly every evening.”
    </p>
    <p>
...
('XII.
THE ADVENTURE OF THE COPPER BEECHES', '<div id="ch12"><h2><a id="chap12"></a>XII.<br>THE ADVENTURE OF THE COPPER BEECHES</h2>
    <p class="pfirst">
    ...
    but the father’s laughter made me think that perhaps he was joking.
    </p>
    <p>
    ...
    which we might give you, you would not object to our little whim. Heh?’
    </p>
    <p>
    ...
    <p>
    “What <i>can</i> be the matter, then? Can you suggest no
    explanation?”
    </p>
    <p>
    ...
    fellow upon the road there who stares up at Miss Hunter.’
    </p>
    <p>
    ...
    <p>
    “‘Dear me! How very impertinent! Kindly turn round and motion
    to him to go away.’
    </p>
    <p>
    ...
    between two planks. ‘Is he not a beauty?’
    </p>
    <p>
    ...
    <p>
    “‘My dear young lady! my dear young lady!’—you
    ...
    you could tell me what it all means, and, above all, what I should do.”
    </p>
    <p>
    ...
    the one that stood your friend, and that I was Miss Alice’s friend too.
    </p>
    <p>
    ...
    standi</i> now is rather a questionable one.”
    </p>
    <p>
